...
<html>
	<head>
        <title>Alan Doe</title>
        <!-- Meta -->
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Responsive HTML5 Developer Resume for Alan Doe">
        <meta name="generator" content="https://www.npmjs.com/package/jsonresume-theme-orbit/v/1.1.1"/>
    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            ...
            <div class="profile-container">
                <img class="profile" src="https://themes.3rdwavemedia.com/demo/orbit/assets/images/profile.png" alt="" />
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    ...
                    <li class="website"><i class="fa fa-globe"></i><a href="http://portfoliosite.com" target="_blank">portfoliosite.com</a></li>
        
                        <li class="linkedin"><i class="fa fa-linkedin"></i><a href="https://linkedin.com/in/alandoe" target="_blank">linkedin.com/in/alandoe</a></li>
                        <li class="github"><i class="fa fa-github"></i><a href="https://github.com/username" target="_blank">github.com/username</a></li>
                        <li class="twitter"><i class="fa fa-twitter"></i><a href="" target="_blank">@twittername</a></li>
            ...
            <div class="education-container container-block">
                <h2 class="container-block-title">Education</h2>
                    ...
                    <div class="item">
                        <h4 class="degree">MSc in Applied Mathematics</h4>
        ...
        <div class="main-wrapper">
            ...
            <section class="section summary-section">
                ...
                <div class="summary">
                    <p>Summarise your career here lorem ipsum dolor sit amet, consectetuer adipiscing elit. You can <a href="https://github.com/XuluWarrior/jsonresume-theme-orbit-original">download this free resume/CV template here</a>. Aenean commodo ligula eget dolor aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu.</p>
                </div><!--//summary-->
            </section><!--//section-->
            ...
            <section class="section projects-section">
                ...
                <!--                    <div class="intro">
                    ...
                    <div class="item">
                        <span class="project-title"><a href="https://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-products-velocity/" target="_blank">Velocity</a></span> -
                    ...
                    <div class="item">
                        <span class="project-title"><a href="http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-startups-tempo/" target="_blank">Tempo</a></span> -
                    ...
                    <div class="item">
                        <span class="project-title"><a href="http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-mobile-apps-atom/" target="_blank">Atom</a></span> -
                    ...
                    <div class="item">
                        <span class="project-title"><a href="http://themes.3rdwavemedia.com/website-templates/responsive-bootstrap-theme-for-mobile-apps-delta/" target="_blank">Delta</a></span> -
